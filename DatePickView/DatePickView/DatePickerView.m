...
#define TOOLBAR_ITEM_TEXT_COLOR [UIColor colorWithRed:63 / 255.0 green:117 / 255.0 blue:255 / 255.0 alpha:1.0]
#define DATE_PICKER_VIEW_BG_COLOR [UIColor colorWithRed:223 / 255.0 green:224 / 255.0 blue:227 / 255.0 alpha:1.0]

typedef enum{
    DatePickerToolBarItemTypeCancel,
...
- (void)show{
    [UIView animateWithDuration:0.5 animations:^{
        ...
        self.transform = CGAffineTransformMakeTranslation(0, - DATE_PICKER_VIEW_HEIGHT);
    }];
}
